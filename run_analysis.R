...
#Load the Training data into R data frames and set the column names in the
#Training data frame based on the data from the features data
...
#Load the Test data into R data frames and set the column names in the
#Test data frame based on the data from the features data
